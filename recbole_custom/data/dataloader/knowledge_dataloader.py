...
"""
recbole_custom.data.dataloader.knowledge_dataloader
################################################
"""
from logging import getLogger
from recbole_custom.data.dataloader.abstract_dataloader import AbstractDataLoader
from recbole_custom.data.dataloader.general_dataloader import TrainDataLoader
from recbole_custom.data.interaction import Interaction
from recbole_custom.utils import InputType, KGDataLoaderState
import numpy as np
...
class KnowledgeBasedDataLoader:
    ...
    In different states, :meth:`~_next_batch_data` will return different :class:`~recbole_custom.data.interaction.Interaction`.
    ...
    Attributes:
        state (KGDataLoaderState):
            This dataloader has three states:
                - :obj:`~recbole_custom.utils.enum_type.KGDataLoaderState.RS`
                - :obj:`~recbole_custom.utils.enum_type.KGDataLoaderState.KG`
                - :obj:`~recbole_custom.utils.enum_type.KGDataLoaderState.RSKG`
