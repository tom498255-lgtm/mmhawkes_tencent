...
"""
recbole_custom.data.sequential_dataset
###############################
"""
...
from recbole_custom.utils.enum_type import FeatureType, FeatureSource


class SequentialDataset(Dataset):
    """:class:`SequentialDataset` is based on :class:`~recbole_custom.data.dataset.dataset.Dataset`,
    ...
    def build(self):
        ...
        Args:
            eval_setting (:class:`~recbole_custom.config.eval_setting.EvalSetting`):
