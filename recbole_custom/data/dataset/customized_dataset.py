...
"""
recbole_custom.data.customized_dataset
##################################
...
from recbole_custom.data.dataset import KGSeqDataset, SequentialDataset
from recbole_custom.data.interaction import Interaction
from recbole_custom.sampler import SeqSampler
from recbole_custom.utils.enum_type import FeatureType
...
class DIENDataset(SequentialDataset):
    """:class:`DIENDataset` is based on :class:`~recbole_custom.data.dataset.sequential_dataset.SequentialDataset`.
    ...
    Attributes:
        augmentation (bool): Whether the interactions should be augmented in recbole_custom.
        seq_sample (recbole_custom.sampler.SeqSampler): A sampler used to sample negative item sequence.
