...
"""
recbole_custom.data.kg_dataset
##########################
"""
...
from recbole_custom.data.dataset import Dataset
from recbole_custom.utils import FeatureSource, FeatureType, set_color
from recbole_custom.utils.url import decide_download, download_url, extract_zip


class KnowledgeBasedDataset(Dataset):
    """:class:`KnowledgeBasedDataset` is based on :class:`~recbole_custom.data.dataset.dataset.Dataset`,
