...
"""
recbole_custom.evaluator.register
################################################
"""
import inspect
import sys
...
def cluster_info(module_name):
    ...
    Args:
        module_name (str): the name of module ``recbole_custom.evaluator.metrics``.
...
metric_module_name = "recbole_custom.evaluator.metrics"
